...
public class SubscriptionsRecord extends UpdatableRecordImpl<SubscriptionsRecord> implements Record2<Long, Long> {
    ...
    @Override
    @NotNull
    public SubscriptionsRecord values(@NotNull Long value1, @NotNull Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
    ...
    public SubscriptionsRecord(@NotNull Long chatId, @NotNull Long linkId) {
        super(Subscriptions.SUBSCRIPTIONS);
