...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record4<Integer, String, OffsetDateTime, OffsetDateTime> {
    ...
    /**
     * Setter for <code>LINKS.LAST_SCHEDULER_CHECK</code>.
     */
    public void setLastSchedulerCheck(@Nullable OffsetDateTime value) {
        set(3, value);
    }

    /**
     * Getter for <code>LINKS.LAST_SCHEDULER_CHECK</code>.
     */
    @Nullable
    public OffsetDateTime getLastSchedulerCheck() {
    ...
    public Field<OffsetDateTime> field4() {
        return Links.LINKS.LAST_SCHEDULER_CHECK;
    }
    ...
    public LinksRecord value4(@Nullable OffsetDateTime value) {
        setLastSchedulerCheck(value);
        return this;
    }

    @Override
    @NotNull
    public LinksRecord values(@Nullable Integer value1, @NotNull String value2, @Nullable OffsetDateTime value3, @Nullable OffsetDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    @ConstructorProperties({ "id", "url", "lastUpdatedAt", "lastSchedulerCheck" })
    public LinksRecord(@Nullable Integer id, @NotNull String url, @Nullable OffsetDateTime lastUpdatedAt, @Nullable OffsetDateTime lastSchedulerCheck) {
        super(Links.LINKS);

        setId(id);
        setUrl(url);
        setLastUpdatedAt(lastUpdatedAt);
        setLastSchedulerCheck(lastSchedulerCheck);
    ...
    public LinksRecord(edu.java.scrapper.domain.jooq.tables.pojos.Links value) {
        ...
        if (value != null) {
            ...
            setLastSchedulerCheck(value.getLastSchedulerCheck());
            resetChangedOnNotNull();
        }
    }
}
