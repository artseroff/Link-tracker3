...
public class Links extends TableImpl<LinksRecord> {
    ...
    /**
     * The column <code>LINKS.LAST_SCHEDULER_CHECK</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_SCHEDULER_CHECK = createField(DSL.name("LAST_SCHEDULER_CHECK"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
