...
@SpringBootTest
public class JdbcSimpleChatServiceTest extends AbstractSimpleChatServiceTest {
    @Autowired
    public JdbcSimpleChatServiceTest(TgChatService tgChatService, TgChatRepository chatRepository) {
